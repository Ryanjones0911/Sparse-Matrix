...
int main() {
    ...
    matrixTest2.addData(4, 4, -6);
    matrixTest2.addData(2, 3, 5);
    matrixTest2.addData(2, 4, 5);
    matrixTest2.addData(1, 2, 8);
    matrixTest2.addData(1, 1, -7);

    matrixTest.viewMatrix();
    matrixTest2.viewMatrix();
    ...
    std::cout << "Element at 3,1 is " << transposed.getElement(3, 1) << std::endl;

    SparseMatrix addition = matrixTest.addMatrix(matrixTest, matrixTest2);
